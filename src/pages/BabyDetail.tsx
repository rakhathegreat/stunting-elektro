...
const BabyDetail: React.FC = () => {
  ...
  const baby: Child = {
    ...
    birthWeight: 3.2,
    birthHeight: 50,
    notes: 'Bayi sehat dengan perkembangan normal. Aktif dan responsif terhadap stimulus.',
    allergies: 'Tidak ada alergi yang diketahui',
    vaccinations: [
      { name: 'BCG', date: '2022-11-20', status: 'Selesai' },
      { name: 'Hepatitis B', date: '2022-12-15', status: 'Selesai' },
      { name: 'DPT-HB-Hib 1', date: '2023-01-15', status: 'Selesai' },
      { name: 'DPT-HB-Hib 2', date: '2023-02-15', status: 'Selesai' }
    ]
  };
  ...
  return (
    ...
    //         className="p-3 rounded-xl border border-gray-200 hover:bg-white hover:shadow-modern transition-all bg-white/80 backdrop-blur-sm"
    //       >
    ...
    //           {baby.name}
    //         </h1>
    //         <p className="text-gray-600 font-medium mt-1">{baby.age} • {baby.gender}</p>
    //       </div>
    //     </div>
    ...
    //   {/* Status Card */}
    //   <div className={`p-8 rounded-2xl border-2 shadow-modern-lg ${
    //     baby.statusColor === 'green' 
    //       ? 'bg-gradient-to-br from-green-50 to-emerald-50 border-green-200'
    //       : baby.statusColor === 'yellow'
    ...
    //         )}
    //         <div>
    //           <h3 className="text-2xl font-bold text-gray-900">Status: {baby.currentStatus}</h3>
    //           <p className="text-gray-600 font-medium mt-1">Berdasarkan pemeriksaan terakhir ({latestGrowth.date})</p>
    //         </div>
    //       </div>
    //       <div className="text-right">
    //         <p className="text-sm text-gray-600 font-semibold">Akurasi Deteksi</p>
    //         <p className="text-4xl font-bold text-gray-900">{latestGrowth.confidence}%</p>
    //       </div>
    //     </div>
    //   </div>
    ...
    //         </div>
    //         <div className={`flex items-center ${heightTrend.color}`}>
    ...
    //       <p className="text-3xl font-bold text-gray-900">{latestGrowth.height} cm</p>
    ...
    //       <p className="text-3xl font-bold text-gray-900">{latestGrowth.weight} kg</p>
    //       <p className="text-xs text-gray-500 font-medium">Sebelum: {previousGrowth.weight} kg</p>
    //     </div>

    //     <div className="card-modern p-6">
    //       <div className="bg-gradient-to-br from-purple-500 to-violet-600 rounded-xl p-3 shadow-modern mb-3">
    //         <Activity className="h-6 w-6 text-white" />
    //       </div>
    //       <p className="text-sm font-semibold text-gray-600">Lingkar Kepala</p>
    //       <p className="text-3xl font-bold text-gray-900">{latestGrowth.headCircumference} cm</p>
    //       <p className="text-xs text-gray-500 font-medium">Normal untuk usia</p>
    //     </div>

    //     <div className="card-modern p-6">
    //       <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-xl p-3 shadow-modern mb-3">
    //         <FileText className="h-6 w-6 text-white" />
    //       </div>
    //       <p className="text-sm font-semibold text-gray-600">Total Pemeriksaan</p>
    //       <p className="text-3xl font-bold text-blue-600">{growthData.length}</p>
    //       <p className="text-xs text-gray-500 font-medium">Sejak {baby.registrationDate}</p>
    //     </div>
    //   </div>
    ...
    //                     <p className="font-bold text-gray-900">{baby.birthDate}</p>
    //                   </div>
    //                 </div>
    //                 <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200">
    ...
    //                     <button 
    //                       onClick={() => navigate(`/parents/${baby.parentId}`)}
    ...
    //                     <p className="font-bold text-gray-900">{baby.registrationDate}</p>
    //                   </div>
    //                 </div>
    //               </div>
    //             </div>
    ...
    //             {/* <div>
    //               <h3 className="text-xl font-bold text-gray-900 mb-6">Data Kelahiran</h3>
    //               <div className="grid grid-cols-2 gap-4">
    //                 <div className="card-modern p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200">
    //                   <p className="text-sm font-semibold text-gray-600">Berat Lahir</p>
    //                   <p className="text-2xl font-bold text-blue-900">{baby.birthWeight} kg</p>
    //                 </div>
    //                 <div className="card-modern p-4 bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200">
    //                   <p className="text-sm font-semibold text-gray-600">Tinggi Lahir</p>
    //                   <p className="text-2xl font-bold text-green-900">{baby.birthHeight} cm</p>
    //                 </div>
    //               </div>
    //             </div> */}
    //           </div>
    ...
    //           <div className="space-y-8">
    //             <div>
    //               <h3 className="text-xl font-bold text-gray-900 mb-6">Catatan Medis</h3>
    //               <div className="card-modern p-6 bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200">
    //                 <p className="text-gray-700 leading-relaxed">{baby.notes}</p>
    //               </div>
    //             </div>

    //             <div>
    //               <h3 className="text-xl font-bold text-gray-900 mb-6">Alergi</h3>
    //               <div className="card-modern p-6 bg-gradient-to-br from-yellow-50 to-orange-50 border border-yellow-200">
    //                 <p className="text-gray-700 font-medium">{baby.allergies}</p>
    //               </div>
    //             </div>
    //           </div>
    //         </div>
    ...
    //           <div className="card-modern p-12 text-center bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200">
    ...
    //                     <p className="text-sm text-gray-600 font-semibold">Lingkar Kepala</p>
    //                     <p className="font-bold text-purple-900 text-xl">{exam.headCircumference} cm</p>
    //                   </div>
    //                 </div>
                    
    //                 <div className="flex justify-between items-center text-sm">
    //                   <span className="text-gray-600 font-medium">Akurasi: <span className="font-bold text-blue-600">{exam.confidence}%</span></span>
    //                   <span className="text-gray-600 font-medium">{exam.notes}</span>
    //                 </div>
    //               </div>
    //             ))}
    //           </div>
    ...
    //         <div className="space-y-6">
    //           <h3 className="text-xl font-bold text-gray-900">Milestone Perkembangan</h3>
    //           <div className="space-y-4">
    //             {milestones.map((milestone, index) => (
    //               <div key={index} className="flex items-center space-x-6 p-6 card-modern">
    //                 <div className={`flex-shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center shadow-modern ${
    //                   milestone.achieved ? 'bg-gradient-to-br from-green-500 to-emerald-600' : 'bg-gradient-to-br from-gray-400 to-gray-500'
    //                 }`}>
    //                   <CheckCircle className="h-6 w-6 text-white" />
    //                 </div>
    //                 <div className="flex-1">
    //                   <h4 className="font-bold text-gray-900 text-lg">{milestone.milestone}</h4>
    //                   <p className="text-sm text-gray-600 font-medium">Target usia: {milestone.age}</p>
    //                   {milestone.achieved && (
    //                     <p className="text-sm text-green-600 font-semibold">Tercapai pada: {milestone.date}</p>
    //                   )}
    //                 </div>
    //               </div>
    //             ))}
      ...
      <div className="col-span-1 bg-white shadow-md rounded-2xl h-full">
        <div className='flex flex-col h-full py-6 px-6 gap-4'>
            ...
            <div className='flex flex-col items-center gap-1'>
              <h3 className="text-xl font-bold text-gray-900">Rakha Fadhillah Anwar</h3>
              ...
              <div className={`p-4 rounded-2xl border-2 shadow-modern-lg ${
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-gray-900">Status: {baby.currentStatus}</h3>
